...
const Review = () => {
    ...
    return (
        <div className="bg-[#101010]">
            <div className="max-w-[1400px] mx-auto lg:flex px-2 md:px-10 lg:px-0 py-[50px] md:py-[150px] gap-8">
                <div className="">
                    <h1 className="text-3xl md:text-5xl text-center lg:text-left font-bold text-white pl-2 md:pl-16 lg:pl-0 lg:max-w-[400px] pb-10 lg:pb-0"> What Customers says</h1>
                </div>
                            ...
                            <div
                                ...
                                {array.map((each, idx) => (
                                    <div key={idx} className="p-4 min-w-full md:min-w-[50%]">
                                        <div className="h-full p-8 rounded shadow-[0px_4px_12px_rgba(0,0,0,0.1)] bg-[#1D1D1D]">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="block w-5 h-5 text-[#00B84B] mb-4" viewBox="0 0 975.036 975.036">
                                            ...
                                            <a className="inline-flex items-center">
                                                ...
                                                <span className="flex-grow flex flex-col pl-4">
                                                    <span className="title-font font-medium text-[#B3B3B3]">{each.name}</span>
                                                    <span className="text-[#B3B3B3] text-sm">{each?.designation}</span>
                                                </span>
                                            </a>
                                        </div>
                                    </div>
